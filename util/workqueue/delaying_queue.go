...
func NewDelayingQueueWithConfig[T comparable](config DelayingQueueConfig[T]) DelayingInterface[T] {
	...
	return newDelayingQueue[T](config.Clock, config.Queue, config.Name, config.MetricsProvider)
}

// NewDelayingQueueWithCustomQueue constructs a new workqueue with ability to
// inject custom queue Interface instead of the default one
// Deprecated: Use NewDelayingQueueWithConfig instead.
func NewDelayingQueueWithCustomQueue[T comparable](q Interface[T], name string) DelayingInterface[T] {
	return NewDelayingQueueWithConfig[T](DelayingQueueConfig[T]{
		Name:  name,
		Queue: q,
	})
...
// Deprecated: Use NewDelayingQueueWithConfig instead.
func NewNamedDelayingQueue[T comparable](name string) DelayingInterface[T] {
	return NewDelayingQueueWithConfig(DelayingQueueConfig[T]{Name: name})
}
...
func newDelayingQueue[T comparable](clock clock.WithTicker, q Interface[T], name string, provider MetricsProvider) *delayingType[T] {
	ret := &delayingType[T]{
		Interface:       q,
		clock:           clock,
